...
function CounterFunction() {
    ...
    return (
        <div style={{ textAlign: "center", marginLeft: "auto", marginRight: "auto", marginTop: "250px", width: "400px", backgroundColor: "grey", border: "10px solid black", borderRadius: "30px" }}>
            <header className="App-header">
                <h1 style={{ textTransform: "uppercase", padding: "20px" }}>Counter Application</h1>
                <h2 style={{ textAlign: "center" }}><a>{counter}</a></h2>
